...
interface BestSellingCarsProps {
	cars: Car[];
	onLikeToggle?: (carId: string, isLiked: boolean) => void;
}

const BestSellingCars: React.FC<BestSellingCarsProps> = ({ cars = [], onLikeToggle }) => {
			...
			<Box className="section-header">
				...
				>
					...
					<Typography variant="body1" className="section-subtitle">
						Discover our most popular vehicles, chosen by discerning customers worldwide
					</Typography>
				</motion.div>

				<Box className="navigation-controls">
					<IconButton className="nav-btn prev-btn" id="best-selling-prev">
						<ArrowBackIcon />
					</IconButton>
					<IconButton className="nav-btn next-btn" id="best-selling-next">
						<ArrowForwardIcon />
					</IconButton>
				</Box>
			</Box>
